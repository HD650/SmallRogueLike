...
class AsteroidsDemo(ShowBase):
    ...
    def __init__(self):
        ...
        self.gameTask = taskMgr.add(self.gameLoop, "{0}gameLoop".format(self))
        self.gameLoop=types.MethodType(MyLoop,self)
        taskMgr.remove("{0}gameLoop".format(self))
        self.gameTask = taskMgr.add(self.gameLoop, "{0}gameLoop".format(self))
